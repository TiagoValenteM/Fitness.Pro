...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=777831396ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=exercises">`fitnesspro`.`exercises`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=friends_post">`fitnesspro`.`friends_post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=friends_follow">`fitnesspro`.`friends_follow`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=exercises_default">`fitnesspro`.`exercises_default`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=weight">`fitnesspro`.`weight`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=users">`fitnesspro`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=profile_img">`fitnesspro`.`profile_img`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=friends_like">`fitnesspro`.`friends_like`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=post">`fitnesspro`.`post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=follow">`fitnesspro`.`follow`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7e375135696b64734e4a64392b2f3f3c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="fitnesspro" targettable="friends_follow">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `friends_follow`  
ORDER BY `friends_follow`.`follower_id` ASC</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `friends_follow` (`follow_id`, `follower_id`, `followed_user_id`) VALUES (&#039;1&#039;, &#039;1&#039;, &#039;3&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fitnesspro" targettable="friends_follow">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `friends_follow`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="fitnesspro" targettable="friends_follow">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `friends_follow` (`follow_id`, `follower_id`, `followed_user_id`) VALUES (&#039;2&#039;, &#039;1&#039;, &#039;7&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fitnesspro" targettable="friends_follow">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `friends_follow`  
ORDER BY `friends_follow`.`followed_user_id` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fitnesspro" targettable="friends_follow">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `friends_follow`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="fitnesspro" targettable="friends_post">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `friends_post`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fitnesspro" targettable="exercises">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `exercises`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fitnesspro" targettable="exercises_default">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `exercises_default`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fitnesspro" targettable="friends_follow">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `friends_post`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="fitnesspro" targettable="profile_img">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `profile_img`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fitnesspro" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="fitnesspro" targettable="weight">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `weight`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fitnesspro" targettable="exercises_default">
                            <div class="action_content">
