...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=users">`fitnesspro`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=profile_img">`fitnesspro`.`profile_img`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=friends_post">`fitnesspro`.`friends_post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=friends_follow">`fitnesspro`.`friends_follow`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=exercises_default">`fitnesspro`.`exercises_default`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=exercises">`fitnesspro`.`exercises`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=weight">`fitnesspro`.`weight`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=friends_like">`fitnesspro`.`friends_like`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=post">`fitnesspro`.`post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fitnesspro&table=follow">`fitnesspro`.`follow`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
